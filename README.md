...
```
$ mkdir $HOME/eks-demo
$ aws s3 cp s3://$S3_BUCKET/$CLUSTER_NAME/config $HOME/eks-demo/config
$ export KUBECONFIG=$KUBECONFIG:$HOME/eks-demo/config
$ kubectl config use-context aws
```

5. Apply generated auth model.
```
$ aws s3 cp s3://$S3_BUCKET/$CLUSTER_NAME/aws-auth-cm.json $HOME/eks-demo/aws-auth-cm.json
$ kubectl apply -f $HOME/eks-demo/aws-auth-cm.json
```
